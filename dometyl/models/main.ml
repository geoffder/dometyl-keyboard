...
let () =
  to_file "skeletyl_right.scad" (Case.to_scad ~show_caps:false @@ skeletyl_right);
  (* to_file "skeletyl_compare.scad" (Skeletyl.bastard_compare ()); *)
  to_file "splaytyl_right.scad" (Case.to_scad ~show_caps:false splaytyl_right);
  to_file "splaytyl_right_plate.scad" (Plate.to_scad splaytyl_right.plate);
  (* to_file "splaytyl_left.scad" (Case.to_scad splaytyl_left); *)
  to_file "bottom_plate_right.scad" (Bottom.make splaytyl_right);
  to_file "closed_right.scad" (Case.to_scad ~show_caps:false @@ closed_right);
  to_file "deractyl_right.scad" (Case.to_scad ~show_caps:true @@ deractyl_right);
  to_file
    "closed_bottom_plate_right.scad"
    (Bottom.make ~bump_locs:Closed.bump_locs_right closed_right);
  to_file "skeletyl_bottom_plate_right.scad" (Skeletyl.bottom skeletyl_right);
  to_file "choc_skeletyl_right.scad" (Case.to_scad ~show_caps:false @@ choc_skeletyl_right);
  to_file "splaytyl_right_tent.scad" (Tent.make ~style:(Tent.prison ()) splaytyl_right)
