...
module SA = struct
  ...
  let r0 = Scad.import_3d (path "R0") |> color
  let r2 = Scad.import_3d (path "R2") |> color
  let r3 = Scad.import_3d (path "R3") |> color
  let r4 = Scad.import_3d (path "R4") |> color
  let r5 = Scad.import_3d (path "R5") |> color
...
module MT3 = struct
  ...
  let space_1u = Scad.import_3d (path "1u-space") |> color
  let space_1_25u = Scad.import_3d (path "1.25u-space") |> color
  let space_1_5u = Scad.import_3d (path "1.5u-space") |> color
...
module Matty3 = struct
  ...
  let r0 = Scad.import_3d (path "R0") |> color
  let r1 = Scad.import_3d (path "R1") |> color
  let r2 = Scad.import_3d (path "R2") |> color
  let r3 = Scad.import_3d (path "R3") |> color
  let r4 = Scad.import_3d (path "R4") |> color
  let r5 = Scad.import_3d (path "R5") |> color
...
module MBK = struct
  ...
  let mbk =
    Scad.import_3d (path "darryldh_MBK/MBK_1u.stl") |> Scad.color Color.DarkSlateBlue
...
module DSA = struct
  (* Generated with https://github.com/rsheldiii/KeyV2 *)
  let r3 = Scad.import_3d (path "KeyV2_DSA/DSA-R3.stl") |> color
  let uniform _ = r3
end
...
module DES = struct
  ...
  let r1 = Scad.import_3d (path "standard/DES-R1") |> color
  let r2 = Scad.import_3d (path "standard/DES-R2") |> color
  let r3 = Scad.import_3d (path "standard/DES-R3") |> color
  let r3_deep = Scad.import_3d (path "standard/DES-R3-deep") |> color
...
module Chicago = struct
  ...
  let thumb_1_5u = Scad.import_3d (path "thumb-1_5u") |> color
